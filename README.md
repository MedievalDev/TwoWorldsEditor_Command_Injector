...
A tool for automating the Two Worlds editor. Automatically detects a running editor instance and executes commands via clipboard injection – single commands or batch execution from TXT command lists.
Features:
